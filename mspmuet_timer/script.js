...
function countdown(time) {
    ...
    const arr = _.range(time, 0, -1);
    const arr2 = _.range(time, 0, -1);
    ...
    const run = () => {
        ...
        seconds -= mnts * 60;
        var toShow =  days + "D " + hrs + "H " + mnts + "M " + seconds + "S";
        arr2[i++] = toShow;
        console.log(toShow);
...
// Change this line to change the time of timer
// Timer Flag
var d2 = new Date(2020, 4, 17, 21, 00, 0);
